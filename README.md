...
![Work](https://img.shields.io/badge/WORK-current%20work-blue?style=?style=plastic&logo=appveyor&logo=csharp) - в работе на данный момент
...
*	Функционал для Администратора ![Work](https://img.shields.io/badge/0-current%20work-blue?style=?style=plastic&logo=appveyor&logo=csharp)
...
### 1.1.	 Функционал подключения приложения к Серверу
```html
...
### 1.2.	 Функционал регистрации и авторизации
...
### 1.3.	Функционал для Администратора
...
### 1.12.	Функционал Производственного календаря
